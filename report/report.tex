...
To investigate the effect of depth on infinite-width networks, we evaluated both architectures across depths $L \in \{3, 4, 6, 11\}$. The results are visualized in Figure \ref{fig:depth_gap}.
